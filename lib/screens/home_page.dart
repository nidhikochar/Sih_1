...
import 'package:elearning/utilities/navigation.dart';
import 'package:elearning/utilities/globals.dart';
import 'package:elearning/database/auth.dart';
...
class _MyHomePageState extends State<MyHomePage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        _currentindex  == 0 ? MyHomeLayout(title: '',) : _currentindex  == 1 ? MySearchLayout(title: '',) : _currentindex  == 2 ? MySavedLayout(title: '',) : MySettingsLayout(title: '',),
...
class MyHomeLayout extends StatefulWidget {
  MyHomeLayout({Key? key, required this.title}) : super(key: key);
...
class _HomeLayoutState extends State<MyHomeLayout>  {
  ...
  late int homeButtonIndex; //For the Home page
...
class MySearchLayout extends StatefulWidget {
  MySearchLayout({Key? key, required this.title}) : super(key: key);
  final String title;
  @override
...
class MySavedLayout extends StatefulWidget {
  MySavedLayout({Key? key, required this.title}) : super(key: key);
  final String title;
  @override
...
class MySettingsLayout extends StatefulWidget {
  MySettingsLayout({Key? key, required this.title}) : super(key: key);
  final String title;
  @override
